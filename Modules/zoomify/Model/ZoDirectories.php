 ...
 */
class ZoDirectories extends Model {
	...
	public function createTable() {
		$sql = "CREATE TABLE IF NOT EXISTS `zo_directories` (
	...
	public function getDirectories(){
		$sql = "select * from zo_directories";
	...
	public function addDir($dirname){
		$sql = "INSERT INTO zo_directories (name)
				 VALUES(?)";
	...
	public function updateDir($id, $dirname){
		$sql = "update zo_directories set name=? where id=?";
	...
	public function isDir($id) {
		$sql = "select name from zo_directories where id=?";
	...
	public function removeDir($id){
		$sql="DELETE FROM zo_directories WHERE id = ?";
	...
	public function removeAll(){
		$sql="DELETE FROM zo_directories";
