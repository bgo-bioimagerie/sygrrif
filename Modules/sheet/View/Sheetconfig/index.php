...
<div class="container">
    	...
    	<div class="page-header">
			<h1>
				<?php echo  ShTranslator::Sheet_configuration($lang) ?> <br> <small></small>
			</h1>
		</div>
		...
		<div class="page-header">
			<h2>
				<?php echo  ShTranslator::Install_Repair_database($lang) ?> <br> <small></small>
			</h2>
		</div>
		
		<form role="form" class="form-horizontal" action="sheetconfig"
		method="post">
		...
		<p>
		<?php echo  ShTranslator::Install_Txt($lang) ?>
		</p>
      ...
      <div>
		  ...
		  method="post">
		    ...
		    <div class="form-group col-xs-12">
				<label for="inputEmail" class="control-label col-xs-4"><?php echo  ShTranslator::Sheet($lang) ?></label>
				<div class="col-xs-6">
					<select class="form-control" name="sheetmenu">
