...
<div class="container">
    	...
    	<div class="page-header">
			<h1>
				<?= ShTranslator::Sheet_configuration($lang) ?> <br> <small></small>
			</h1>
		</div>
		...
		<div class="page-header">
			<h2>
				<?= ShTranslator::Install_Repair_database($lang) ?> <br> <small></small>
			</h2>
		</div>
      ...
      <div>
		  ...
		  method="post">
		    ...
		    <div class="form-group col-xs-12">
				<label for="inputEmail" class="control-label col-xs-4"><?= ShTranslator::Sheet($lang) ?></label>
				<div class="col-xs-6">
