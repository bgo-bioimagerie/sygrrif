...
<div class="container">
    	...
    	<div class="page-header">
			<h1>
			<?php echo  QoTranslator::Quotes_configuration($lang) ?>
			 <br> <small></small>
			</h1>
		</div>
		...
		<div class="page-header">
			<h2>
			<?php echo  QoTranslator::Install_Repair_database($lang) ?>
				<br> <small></small>
			</h2>
		</div>
		
		<form role="form" class="form-horizontal" action="quotesconfig"
		method="post">
		...
		<p>
		<?php echo QoTranslator::Install_Txt($lang) ?>
		</p>
      ...
      <div>
		  <div class="page-header">
			<h2>
			<?php echo  QoTranslator::Activate_desactivate_menus($lang) ?>
				<br> <small></small>
			</h2>
		  </div>
