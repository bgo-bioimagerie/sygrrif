...
class ControllerSygrrif extends ControllerBooking {
    ...
    public function statauthorizations() {
        ...
        if ($testPass) {
            ...
            if ($view_counting != "") {
                $msData = $modelAuth->minimalStatistics($searchDate_start, $searchDate_end, $user_id, $curentunit_id, $trainingunit_id, $visa_id, $resource_id);
            }

            if ($view_details != "") {
                $dsData = $modelAuth->statsDetails($searchDate_start, $searchDate_end, $user_id, $curentunit_id, $trainingunit_id, $visa_id, $resource_id, $lang);
            }
