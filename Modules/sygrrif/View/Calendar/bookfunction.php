<?php 
function bookday($size_bloc_resa, $date_unix, $day_begin, $day_end, $calEntries, $calRes, $isUserAuthorizedToBook, $isDayAvailable){
	...
	if($isneurinfo){
		$paramcalendrier= new Projet_Calendar_Parametre();
