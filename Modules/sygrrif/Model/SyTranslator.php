...
public static function inst($lang=""){
	if($lang== "Fr"){
		return utf8_encode("Installer/R�parer la base de donn�e");
	}
	return "Install / Repair database";
}
public static function paragraphe($lang=""){
	if($lang="Fr"){
	 	return utf8_encode("Pour installer le mudule SyGRRif, cliquez sur Installer. Cela va cr�er les tables 
SyGRRif  dans la base de donn�es, si elles n'existent pas ou les r�parer si elles existent");	
	}
...
public static function model($lang=""){
	if($lang=="Fr"){
		return utf8_encode("Mod�le");
	}
	return "Bill template";
}
public static function para2($lang=""){
	if($lang=="Fr"){
		return utf8_encode("S�lectionnez un fichier xls qui sera utilis� comme mod�le pour g�n�rer le projet SyGRRif");
	}
...
public static function bookingsum($lang=""){
	if($lang=="Fr"){
		return utf8_encode("les options du sommaires des r�servations");
	}
	return "Booking summary options ";
}
public static function hiden($lang=""){
	if($lang=="Fr"){
		return utf8_encode("Cach�");
	}
	return "Hidden";
}
public static function taghiden($lang=""){
	if($lang=="Fr"){
		return utf8_encode("Tag cach�");
	}
	return "Tag hidden";
}
...
public static function validecondition($lang = ""){
	...
	public static function resertrouve($lang=""){
		if($lang=="Fr"){
			return utf8_encode("R�servations Trouv�es");
		}
	...
	public static function Unactive_Authorizations($lang = ""){
		...
		return "Unactive Authorizations";
	}
	...
	public static function Full_description($lang = ""){
		if ($lang == "Fr"){
			return utf8_encode("Description compl�te");
		}
	...
	public static function Statistics_authorizations($lang = ""){
		...
		return "Statistics authorizations";
	}
	...
	public static function numreservation($lang=""){
		if($lang=="Fr")
		{
			return utf8_encode("Num�ro de r�servation");
		}
		return "Reservation number";
	}
...
public static function manager($lang = ""){
		if ($lang == "Fr"){
			return utf8_encode("G�stionnaire");
		}
		return "Manager";
	}
...
public static function Short_description($lang){
	...
	public static function Recipient($lang){
		if($lang=="Fr"){
			return Utf8_encode("Nom de l'�metteur") ;
		}
		else{
...
public static function taghidden($lang){
		if($lang=="Fr"){
			return Utf8_encode("Balise Cach�e") ;
		}
		else{
			return "Tag Hidden";
		}
	...
	public static function series($lang){
		if($lang="Fr"){
			return utf8_encode("S�ries des r�servations");
		}
