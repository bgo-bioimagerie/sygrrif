...
<div class="container">
    	...
    	<div class="page-header">
			<h1>
			<?php echo  AgTranslator::Agenda_configuration($lang) ?>
			 <br> <small></small>
			</h1>
		</div>
		...
		<div class="page-header">
			<h2>
			<?php echo  AgTranslator::Install_Repair_database($lang) ?>
				<br> <small></small>
			</h2>
		</div>
		
		<form role="form" class="form-horizontal" action="agendaconfig"
		method="post">
		...
		<p>
		<?php echo  AgTranslator::Install_Txt($lang) ?>
		</p>
      ...
      <div>
		  <div class="page-header">
			<h2>
			<?php echo  AgTranslator::Activate_desactivate_menus($lang) ?>
				<br> <small></small>
			</h2>
		  </div>
