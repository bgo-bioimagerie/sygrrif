 ...
 *
 */
class ControllerCoreunits extends ControllerSecureNav {
	...
	public function index() {
		...
		$table->addLineEditButton("coreunits/edit");
		$table->addDeleteButton("coreunits/delete");
		$table->addPrintButton("coreunits/index/");
	...
	public function edit() {
		...
		$form->setValidationButton(CoreTranslator::Ok($lang), "Coreunits/edit");
		$form->setCancelButton(CoreTranslator::Cancel($lang), "Coreunits");
