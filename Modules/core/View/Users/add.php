	...
	<?php if ($isneurinfo){?> 
	  <form role="form" action="users/addquery" method="post">
		...
		<div class="form-group">
			<label for="inputEmail" class="col-lg-2 control-label"><?= CoreTranslator::Name($lang) ?></label>
			<div class="col-lg-10">
		...
		<br/>
		<div class="form-group">
			<label for="inputEmail" class="col-lg-2 control-label"><?= CoreTranslator::Firstname($lang) ?></label>
			<div class="col-lg-10">
		...
		<br/>
		<div class="form-group">
			<label for="login" class="col-lg-2 control-label"><?= CoreTranslator::Login($lang) ?></label>
			<div class="col-lg-10">
		...
		<div class="form-group">
			<label for="pwd" class="col-lg-2 control-label"><?= CoreTranslator::Password($lang) ?></label>
			<div class="col-lg-4">
				<input type="password" class="form-control" id="pwd" name="pwd" placeholder="Password">
			</div>
			<label for="pwdc" class="col-lg-2 control-label"><?= CoreTranslator::Confirm($lang) ?></label>
			<div class="col-lg-4">
		...
		<div class="form-group">
			<label for="inputEmail" class="col-lg-2 control-label"><?= CoreTranslator::Email($lang) ?></label>
			<div class="col-lg-10">
		...
		<div class="form-group">
			<label for="inputEmail" class="col-lg-2 control-label"><?= CoreTranslator::Phone($lang) ?></label>
			<div class="col-lg-10">
		...
		<div class="form-group">
			<label for="inputEmail" class="col-lg-2 control-label"><?= CoreTranslator::Status($lang) ?></label>
			<div class="col-lg-10">
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
					...
					<div class="radio">
       						<label>
								<input type="radio" id="convention"  name="convention" value="oui" >Oui
							</label>
						</div>
						<div class="radio">
       						<label>
								<input type="radio" id="convention"  name="convention" value="non" >Non
							</label>
						</div>					
					</div>
