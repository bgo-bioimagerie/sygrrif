	...
	<form role="form" class="form-horizontal" action="coresites/siteusersquery"
		method="post">
            ...
            <div class="page-header">
                <h1>
                <?php echo CoreTranslator::Managers_for_site($lang) . ": " . $siteInfo["name"] ?> 
		<br> <small></small>
                </h1>
            </div>
                ...
                <tr>
                    ...
                    <td>
                    	<select class="form-control" name="id_status[]">
                            ...
                            ?>
                            <OPTION value="3" <?php if($id_status == 3){ echo "selected=\"selected\"";} ?>> <?php echo CoreTranslator::Manager($lang) ?> </OPTION>
                            <OPTION value="4" <?php if($id_status == 4){ echo "selected=\"selected\"";} ?>> <?php echo CoreTranslator::Admin($lang) ?> </OPTION>
                ...
                <tr>
                    ...
                    <td>
                    	<select class="form-control" name="id_status[]">
                            ...
                            <OPTION value="3" > <?php echo CoreTranslator::Manager($lang) ?> </OPTION>
                            <OPTION value="4" > <?php echo CoreTranslator::Admin($lang) ?> </OPTION>
                        </select>
                    </td>
