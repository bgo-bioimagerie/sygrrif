		...
		<div class=<?php echo  $classWell ?> >
			<fieldset>
				<legend><?php echo  CoreTranslator::Sites($lang) ?></legend>
					<button onclick="location.href='coresites/'" class="btn btn-link" id="navlink"><?php echo CoreTranslator::Sites($lang) ?></button>
					<button onclick="location.href='coresites/edit'" class="btn btn-link" id="navlink">+</button>
			</fieldset>
		</div>
