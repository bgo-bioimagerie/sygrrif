...
<div class="container">
      ...
      <div>
		  <div class="page-header">
			<h2>
				<?=CoreTranslator::User_list_options($lang)?> <br> <small></small>
			</h2>
		  </div>
      ...
      <div>
		...
		<div class="form-group">
			...
			<div class="col-xs-6">
				<input class="form-control" id="coremenucolor" type="color" name="coremenucolor" value="<?= $this->clean($coremenucolor) ?>"
				/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-xs-6">
				<input class="form-control" id="coremenucolor" type="color" name="coremenucolortxt" value="<?= $this->clean($coremenucolortxt) ?>"
				/>
			</div>
		</div>
