 ...
 */
class PsExitReason extends Model {
    ...
    public function createTable() {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS `ps_exit_reason` (
    ...
    public function createDefault() {
        ...
        if (!$this->exists(1)) {
            $sql = "INSERT INTO ps_exit_reason (name) VALUES(?)";
    ...
    public function add($name) {
        ...
        $sql = "insert into ps_exit_reason(name)"
                . " values(?)";
    ...
    public function edit($id, $name) {
        ...
        $sql = "update ps_exit_reason set name=? where id=?";
    ...
    public function exists($id) {
        $sql = "select * from ps_exit_reason where id=?";
    ...
    public function getId($name) {
        $sql = "select id from ps_exit_reason where name=?";
    ...
    public function delete($id) {
        $sql = "DELETE FROM ps_exit_reason WHERE id = ?";
