 ...
 */
class SpItemPricing extends Model {
	
	public function createTable(){
		$sql = "CREATE TABLE IF NOT EXISTS `sp_j_item_pricing` (
	...
	public function editPricing($id_item, $id_pricing, $price){
		...
		$sql = "update sp_j_item_pricing set price=? 
	...
	public function isPricing($id_item, $id_pricing){
		$sql = "select * from sp_j_item_pricing where id_item=? AND id_pricing=?";
