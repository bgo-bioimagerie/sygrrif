...
class SpUser extends Model {
	...
	public function createDefaultUser(){
		...
		if (!$this->isUser("--")){
			...
			$sql = "INSERT INTO sp_users (firstname, name, id_unit,
    ...
    public function getActiveUsers($sortentry = 'id'){
    	...
    	$sql = "select * from sp_users where is_active >= 1 order by " . $sortentry . " ASC;";
    	$user = $this->runRequest($sql);
    	return $user->fetchAll();
    }
    ...
    public function addUser($name, $firstname, 
    	...
    	$sql = "insert into sp_users(firstname, name, email, tel, id_unit, id_responsible, 
    ...
    public function updateUser($id, $name, $firstname, 
    	...
    	$sql = "update sp_users set firstname=?, name=?, email=?, tel=?, id_unit=?, id_responsible=?,
    			                      is_active=? 
    			                  where id=?";
    ...
    public function activate($userId){
    	...
    	$sql = "update sp_users set is_active=?, 
    		           where id=?";
