...
<div class="container">
	...
	<form role="form" class="form-horizontal" action="sprojectspricing/addunitpricingquery"
		method="post">
	
		<div class="page-header">
			<h1>
			<?php echo  SpTranslator::Associate_a_pricing_to_a_unit($lang) ?>
				<br> <small></small>
			</h1>
		</div>
		...
		<div class="form-group">
			<label for="inputEmail" class="control-label col-xs-2"><?php echo  SpTranslator::Pricing($lang) ?></label>
			<div class="col-xs-10">
		...
		<div class="col-xs-4 col-xs-offset-8" id="button-div">
				...
				<button type="button" onclick="location.href='sprojectspricing/unitpricing'" class="btn btn-default"><?php echo  CoreTranslator::Cancel($lang) ?></button>
		</div>
      </form>
	</div>
</div>
