...
class Enzyme extends Model {
	 ...
	 * 
	 */
	public function addEnzyme($name){
	
		$sql = "insert into ac_enzymes(nom)"
				. " values(?)";
	 ...
	 */
	public function editEnzyme($id, $name){
	
		$sql = "update ac_enzymes set nom=? where id=?";
