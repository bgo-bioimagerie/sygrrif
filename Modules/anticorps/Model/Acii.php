...
class Acii extends Model {
	 ...
	 * 
	 */
	public function addAcii($name){
	
		$sql = "insert into ac_aciis(nom)"
				. " values(?)";
	 ...
	 */
	public function editAcii($id, $name){
	
		$sql = "update ac_aciis set nom=? where id=?";
