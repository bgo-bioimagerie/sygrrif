...
<div class="container">
	...
	<form role="form" class="form-horizontal" action="option/editquery"
		method="post">
	
	
		<div class="page-header">
			<h1>
				Modifier option <br> <small></small>
			</h1>
		</div>
		...
		<input class="form-control" id="id" type="hidden"  name="id" value="<?php echo  $option['id']?>" />
		...
		<div class="col-xs-6 col-xs-offset-6" id="button-div">
		        ...
		        <button type="button" onclick="location.href='<?php echo "option/delete/".$option['id'] ?>'" class="btn btn-danger"><?php echo  SyTranslator::Delete($lang)?></button>
				<button type="button" onclick="location.href='option'" class="btn btn-default">Cancel</button>
		</div>
      </form>
	</div>
</div>
