...
<div class="container">
    	...
    	<div class="page-header">
			<h1>
				Anticorps configuration <br> <small></small>
			</h1>
		</div>
		...
		<form role="form" class="form-horizontal" action="anticorpsconfig"
		method="post">
		...
		<p>
		To repair the Anticorps module, click "Install". This will create the 
		Anticorps tables in the database if they don't exists or repair them
		if they exists
		</p>
