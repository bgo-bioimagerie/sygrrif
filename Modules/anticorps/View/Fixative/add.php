...
<div class="container">
	...
	<form role="form" class="form-horizontal" action="fixative/addquery"
		method="post">
	
	
		<div class="page-header">
			<h1>
				Ajouter Fixative <br> <small></small>
			</h1>
		</div>
		...
		<div class="col-xs-4 col-xs-offset-8" id="button-div">
				...
				<button type="button" onclick="location.href='fixative'" class="btn btn-default">Annuler</button>
		</div>
      </form>
	</div>
</div>
