...
<div class="container">
	...
	<form role="form" class="form-horizontal" action="dem/editquery"
		...
		<input class="form-control" id="id" type="hidden"  name="id" value="<?= $dem['id']?>" />
		...
		<div class="col-xs-6 col-xs-offset-6" id="button-div">
		        ...
		        <button type="button" onclick="location.href='<?="dem/delete/".$dem['id'] ?>'" class="btn btn-danger"><?= SyTranslator::Delete($lang)?></button>
