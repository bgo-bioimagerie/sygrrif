...
<div class="container">
	...
	<form role="form" class="form-horizontal" action="inc/editquery"
		...
		<div class="col-xs-6 col-xs-offset-6" id="button-div">
		        ...
		        <button type="button" onclick="location.href='<?php echo "inc/delete/".$inc['id'] ?>'" class="btn btn-danger"><?php echo  SyTranslator::Delete($lang)?></button>
