...
<div class="container">
	...
	<form role="form" class="form-horizontal" action="isotypes/editquery"
		...
		<div class="form-group">
			...
			<div class="col-xs-10">
				<input class="form-control" id="id" type="text" name="id" disabled
				       value="<?php echo  $isotype['id'] ?>"  
				/>
			</div>
		</div>
	
		<input class="form-control" id="id" type="hidden"  name="id" value="<?php echo  $isotype['id']?>" />
	
		<div class="form-group">
			<label for="inputEmail" class="control-label col-xs-2">Nom</label>
			<div class="col-xs-10">
				<input class="form-control" id="nom" type="text" name="nom"
				       value="<?php echo  $isotype['nom'] ?>"  
				/>
			</div>
		</div>
		<br></br>		
		<div class="col-xs-6 col-xs-offset-6" id="button-div">
		        ...
		        <button type="button" onclick="location.href='<?php echo "isotypes/delete/".$isotype['id'] ?>'" class="btn btn-danger"><?php echo  SyTranslator::Delete($lang)?></button>
