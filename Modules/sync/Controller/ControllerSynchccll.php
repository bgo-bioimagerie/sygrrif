...
class ControllerSynchccll extends Controller {
	...
	public function index() {
		...
		// connect to h2p2 grr 
		$dsn_grr = 'mysql:host=localhost;dbname=ccl2;charset=utf8';
		$login_grr = "root";
		$pwd_grr = "";
	...
	protected function syncUnits($pdo_grr){
		...
		foreach ($units_old as $unit){
			$unitModel->addUnit($unit['equipe_name'], $unit['equipe_address'], 1);
		}
	}
