...
<div class="container">
    	...
    	<div class="page-header">
			<h1>
			<?php echo  WbTranslator::Web_configuration($lang) ?>
			 <br> <small></small>
			</h1>
		</div>
		...
		<div class="page-header">
			<h2>
			<?php echo  WbTranslator::Install_Repair_database($lang) ?>
				<br> <small></small>
			</h2>
		</div>
		
		<form role="form" class="form-horizontal" action="webconfig"
		method="post">
		...
		<p>
		<?php echo  WbTranslator::Install_Txt($lang) ?>
		</p>
      ...
      <div>
		  <div class="page-header">
			<h2>
			<?php echo  WbTranslator::Activate_desactivate_menus($lang) ?>
				<br> <small></small>
			</h2>
		  </div>
