...
<div class="container">
    	...
    	<div class="page-header">
			<h1>
				<?= ProjetTranslator::Projet_configuration($lang) ?> <br> <small></small>
			</h1>
		</div>
		...
		<form role="form" class="form-horizontal" action="Projetconfig"
		method="post">
      ...
      <div>
		  ...
		  method="post">
		    ...
		    <div class="form-group">
				<label for="inputEmail" class="control-label col-xs-4">Projet</label>
				<div class="col-lg-6">
					<select class="form-control" name="projetmenu">
		    ...
		    <div class="form-group">
				<label for="inputEmail" class="control-label col-xs-4">Projet Calendrier</label>
				<div class="col-lg-6">
					<select class="form-control" name="projetcalendar">
			...
			<div class="form-group">
				<label for="inputEmail" class="control-label col-xs-4">Tarifs Neurinfo</label>
				<div class="col-lg-6">
					<select class="form-control" name="TarifsNeurinfo">
						<OPTION value="0" <?php if($menuCalendar["statuscalendar"]==0){echo "selected=\"selected\"";} ?> > <?= CoreTranslator::disable($lang) ?> </OPTION>
						<OPTION value="1" <?php if($menuCalendar["statuscalendar"]==1){echo "selected=\"selected\"";} ?> > <?= CoreTranslator::enable_for_visitors($lang) ?> </OPTION>
						<OPTION value="2" <?php if($menuCalendar["statuscalendar"]==2){echo "selected=\"selected\"";} ?> > <?= CoreTranslator::enable_for_users($lang) ?> </OPTION>
						<OPTION value="3" <?php if($menuCalendar["statuscalendar"]==3){echo "selected=\"selected\"";} ?> > <?= CoreTranslator::enable_for_manager($lang) ?> </OPTION>
