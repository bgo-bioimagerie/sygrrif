...
<div class="container">
	...
	<form name="form" class="form-horizontal" action="Stat/report"
		...
		<div class="form-group">
			...
			?>
				...
				<select class="form-control" name="champ[]" >
					...
					else if ($champ[$i] == "codeanonyma"){
						$checkedCA = "selected=\"selected\"";
					}
					else if ($champ[$i] == "numerovisite"){
						$checkedNV = "selected=\"selected\"";
					}
					...
					<OPTION value="codeanonyma" <?= $checkedCA ?>> <?= SyTranslator::codeanonymation($lang) ?> </OPTION>
					<OPTION value="numerovisite" <?= $checkedNV ?>> <?= SyTranslator::numreservation($lang) ?> </OPTION>
...
<table class="table table-striped text-center table-bordered">
   ...
   <thead> 
       <tr>				
           ...
           <th> <?= SyTranslator::codeanonymation($lang) ?> </th>
           <th> <?= SyTranslator::numreservation($lang) ?> </th>
   ...
   <tbody> 
       ...
       <tr>
           ...
           <?php 
           $date = "debut : " . date( "d/m/Y a H:i", $t["start_time"]) . "<br/>";
           $date .= "fin : " . date( "d/m/Y a H:i", $t["end_time"]) . "<br/>";
           $date .= "duree : " . ($t["end_time"] - $t["start_time"])/60 . " minutes";
           ?>
           
           <td><?= $date ?></td>
           <td><?= $t["codeanonyma"] ?></td>
            <td><?= $t["numerovisite"] ?></td>
           <td><?= $t["color"] ?></td>
           <td><?= $t["login"] ?></td>
       </tr>
