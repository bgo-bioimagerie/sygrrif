...
class TableView
{
    ...
    public function view($data, $headers){
    	...
    	if ($this->useSearchVal && !$this->isprint){
    		...
    		if ($this->editURL != ""){$headerCount++;}
    		if ($this->deleteURL != ""){$headerCount++;}
    ...
    private function addSearchHeader($html, $headerscount){
    	...
    	$html .= "<link rel=\"stylesheet\" href=\"externals/fixedHeaderTable/dataTables.bootstrap.css\">";
    	$html .= "<link rel=\"stylesheet\" href=\"externals/fixedHeaderTable/dataTables.fixedHeader.css\">";
    	
    	$html .= "<script src=\"externals/jquery-1.11.1.js\"></script>";
    	$html .= "<script src=\"externals/fixedHeaderTable/jquery.dataTables.js\"></script>";
    	$html .= "<script src=\"externals/fixedHeaderTable/dataTables.fixedHeader.min.js\"></script>";
    	$html .= "<script src=\"externals/fixedHeaderTable/dataTables.bootstrap.js\"></script>";
